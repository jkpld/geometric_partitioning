function S = homogenize_image(I,BW,CC,options)
% HOMOGENIZE_IMAGE  Get the edges between sub-objects in an object
%
% S = homogenize_image(I,BW,CC,options)
%
% I - input image
% BW - object mask
...
% James Kapaldo
% 2016-11-28
% 2017-01-19 : no longer have S = 1./S at end, renamed to homogenize_image
...
if options.Use_GPU
    S = homogenize_image_GPU(I,BW,CC,params);
else
    S = homogenize_image_CPU(I,BW,CC,params);
end

end

function S = homogenize_image_CPU(I,BW,CC,params)
...
function S = homogenize_image_GPU(I,BW,CC,params)
